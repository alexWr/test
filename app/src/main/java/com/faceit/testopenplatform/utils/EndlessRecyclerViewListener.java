...
/**
 * Created by hotyun_a on 06.03.17.
 */
...
public abstract class EndlessRecyclerViewListener extends RecyclerView.OnScrollListener {
    ...
    private int completeVisibleItemPosition = 0;
    ...
    public EndlessRecyclerViewListener(StaggeredGridLayoutManager layoutManager, FloatingActionButton fab) {
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }
    ...
    public void onScrolled(RecyclerView view, int dx, int dy) {
        ...
        if (mLayoutManager instanceof StaggeredGridLayoutManager) {
            ...
            completeVisibleItemPosition = ((LinearLayoutManager) mLayoutManager).findFirstCompletelyVisibleItemPosition();
